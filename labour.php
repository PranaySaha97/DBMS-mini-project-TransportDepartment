...
$bdes=$_POST['bdes'];
$query= "INSERT INTO insurance VALUES('".mysqli_real_escape_string($res,$vreg)."','".mysqli_real_escape_string($res,$rdate)."','".mysqli_real_escape_string($res,$rfrom)."','".mysqli_real_escape_string($res,$bnum)."','".mysqli_real_escape_string($res,$bamount)."','".mysqli_real_escape_string($res,$bdes)."')";
