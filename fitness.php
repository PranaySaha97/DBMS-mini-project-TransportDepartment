...
$query= "INSERT INTO fitness VALUES('".mysqli_real_escape_string($res,$certificate_number)."','".mysqli_real_escape_string($res,$vehicle_no)."','".mysqli_real_escape_string($res,$rto_name)."','".mysqli_real_escape_string($res,$expirydate)."','".mysqli_real_escape_string($res,$renewaldate)."','".mysqli_real_escape_string($res,$fee_amount)."')";
